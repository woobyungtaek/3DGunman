...
// 씬을 생성합니다.
void D3DApp::AllSceneLoad()
{
	// 0 : 데이터 로드 씬
	LoadScene* dataLoadScene = new LoadScene();
	BTScene::CreateScene(dataLoadScene);
	...
	BTScene::CreateScene(lobbyScene);

	// 3 : 게임 씬
	GameScene* gameScene = new GameScene();
	BTScene::CreateScene(gameScene);
	//
